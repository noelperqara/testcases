...
WebUI.click('tombol lihat semua advokat')

String expectedurl = 'https://staging.perqara.com/cari-advokat'

String actualurl = WebUI.getUrl()

assert actualurl == expectedurl ; "Pengguna tidak diarahkan ke halaman daftar advokat"
