...
WebUI.click('tombol panduan memilih advokat')

String expectedurl = 'https://staging.perqara.com/advokatmu/identifikasi'

String actualurl = WebUI.getUrl()

assert actualurl == expectedurl ; "Pengguna tidak diarahkan ke halaman decision tree"
