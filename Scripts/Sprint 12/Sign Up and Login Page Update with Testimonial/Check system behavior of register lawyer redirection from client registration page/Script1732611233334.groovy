...
WebUI.click(findTestObject('Object Repository/perqara landing page/halaman daftar/tombol advokat perqara register'))

String expectedurl = 'https://staging.perqara.com/register/advokat'
